...
func (c *meteredConn) Read(b []byte) (n int, err error) {
	fmt.Println("Read over metered TCP from", c.RemoteAddr().String(), "to", c.LocalAddr().String())
...
func (c *meteredConn) Write(b []byte) (n int, err error) {
	fmt.Println("Write over metered TCP from", c.LocalAddr().String(), "to", c.RemoteAddr().String())
